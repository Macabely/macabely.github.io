...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-11%20204934.png)

I opened the challenge, and it was a login page...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20113232.png)
...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20114332.png)
...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20120139.png)
...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20140959.png)
...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20141819.png)
...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20142733.png)
...
![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20150808.png)

Start the attack and see what happens.

![image](images/cyberx/silent-bypass/Screenshot%202025-08-08%20151051.png)
...
    print(f"\nerror: {e}")
 sys.exit(1)
```
![image](images/cyberx/silent-bypass/Screenshot%202025-08-07%20173719.png)
***

# Obfuscated Echo
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-11%20205459.png)
...
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-08%20211001.png)
...
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-08%20212152.png)
...
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-08%20214821.png)
...
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-08%20215542.png)
...
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-09%20203642.png)
...
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-09%20204745.png)

Yup, the single quotes and double quotes too are being sanitized by a blind WAF that i couldn't really see in the code provided by the debugger.
...
![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-11%20202910.png)

To get the flag, change the `/etc/passwd` part with `flag.txt`

And we successfully got the flag.

![image](images/cyberx/obfuscated-echo/Screenshot%202025-08-10%20221121.png)
...
<figure>
  <img src="/images/cyberxbytes/obfuscated-echo/Screenshot%202025-08-10%20221504.png" alt="Flag">
...
![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20204752.png)
...
![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20210119.png)
...
![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20210352.png)

Yup, the debugger is left open.

I started creating an account to login. After  a successful login you will see this.

![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20211254.png)
...
![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20211925.png)
...
![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20212301.png)
...
![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20213844.png)

Cool, we triggered an error, and we got what we want. I copied the response into the browser and found this code.

![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20214052.png)
...
![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20215217.png)

![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20215152.png)

And we got the flag

![image](images/cyberx/hackthepass/Screenshot%202025-08-11%20215326.png)